...
if __name__ == "__main__":
    group1 = group
    assert len(group1) == 4, "Group should have 4 members"
    assert average_age(group1) == 28.75, "Average age of the group is incorrect!"
    assert len(group1["Nash"]["relations"]) == 1, "Nash should only have one relation"
